...
<body>
	...
	<main>
		...
		<form id="input_form" method="post" action="/board/save"
			...
			<input type="hidden" name="pcodeMac" value="${board.pcodeMac}">
			<input type="hidden" name="nicknameMac" value="${board.nicknameMac}">
			<div>
				<select name="type">
			...
			<div>
				<label for="titleMac">제목</label> <input type="text" id="titleMac"
					name="titleMac">
			</div>
			<div>
				<label for="contentsMac">내용</label>
				<textarea id="contentsMac" name="contentsMac" placeholder="글 입력..."></textarea>
			</div>
			<div>
